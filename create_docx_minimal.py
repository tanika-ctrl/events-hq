#!/usr/bin/env python3
"""Create DBR April 2026 time analysis report as DOCX"""
...
try:
    ...
    output_path_1 = '/Users/tanikafacey/Desktop/Cowork/2026-04-30-DBR-April-Time-Analysis.docx'
    output_path_2 = '/sessions/intelligent-zen-cerf/mnt/Cowork/2026-04-30-DBR-April-Time-Analysis.docx'

    doc.save(output_path_1)
    print(f'SUCCESS: {output_path_1}')

    # Try to save to session path if it exists
    try:
        doc.save(output_path_2)
        print(f'SUCCESS: {output_path_2}')
    except Exception as e:
        print(f'Note: Could not save to session path: {e}')
